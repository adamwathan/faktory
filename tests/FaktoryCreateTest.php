...
class FaktoryCreateTest extends FunctionalTestCase
{
    ...
    {
        $this->faktory->define('Album', 'album_with_5_songs', function ($f) {
            $f->name = 'Chaosphere';
            $f->release_date = new DateTime;
            $f->songs = $f->hasMany('song', 5, 'album_id');
        });
        $this->faktory->define('Album', 'album_with_7_songs', function ($f) {
            $f->name = 'Destroy Erase Improve';
            $f->release_date = new DateTime;
            $f->songs = $f->hasMany('song', 7, 'album_id');
        });
        $this->faktory->define('Song', 'song', function ($f) {
    ...
    {
        $this->faktory->define('Comment', 'comment', function ($f) {
            $f->body = 'This post is great';
        });
        $this->faktory->define('Post', 'post_with_5_comments', function ($f) {
            $f->title = 'Sweet post';
            $f->comments = $f->hasMany('comment', 5, 'post_id');
        });
        $this->faktory->define('Post', 'post_with_7_comments', function ($f) {
            $f->title = 'Sweet post';
    ...
    {
        $this->faktory->define('Song', 'song_with_album', function ($f) {
            $f->name = 'Concatenation';
            $f->length = 257;
            $f->album = $f->belongsTo('album', 'album_id');
        });
        $this->faktory->define('Album', 'album', function ($f) {
            $f->name = 'Chaosphere';
            $f->release_date = new DateTime;
        });
        ...
        $this->faktory->define('Comment', 'comment_with_post', function ($f) {
            $f->body = 'Great post';
    ...
    {
        $this->faktory->define('Album', 'album_with_song', function ($f) {
            $f->name = 'Chaosphere';
            $f->release_date = new DateTime;
    ...
    {
        $this->faktory->define('Post', 'post_with_comments', function ($f) {
            $f->title = 'First Post';
    ...
    {
        $this->faktory->define('Album', 'album_with_songs', function ($f) {
            $f->name = 'Sabotage';
