...
class FaktoryCreateTest extends FunctionalTestCase
{
    ...
    {
        $this->faktory->define(['album_with_5_songs', 'Album'], function($f) {
            $f->name = 'Chaosphere';
            $f->release_date = new DateTime;
            $f->songs = $f->hasMany('song', 5, 'album_id');
        });
        $this->faktory->define(['album_with_7_songs', 'Album'], function($f) {
    ...
    public function test_saved_has_many_get_correct_foreign_id_different_classes()
    {
        ...
        $this->faktory->define(['post_with_5_comments', 'Post'], function($f) {
            $f->title = 'Sweet post';
            $f->comments = $f->hasMany('comment', 5, 'post_id');
        });
        $this->faktory->define(['post_with_7_comments', 'Post'], function($f) {
            $f->title = 'Sweet post';
    ...
    {
        $this->faktory->define(['song_with_album', 'Song'], function($f) {
            $f->name = 'Concatenation';
            $f->length = 257;
        ...
        $this->faktory->define(['comment_with_post', 'Comment'], function($f) {
            $f->body = 'Great post';
    ...
    {
        $this->faktory->define(['album_with_song', 'Album'], function($f) {
            $f->name = 'Chaosphere';
            $f->release_date = new DateTime;
    ...
    {
        $this->faktory->define(['post_with_comments', 'Post'], function($f) {
            $f->title = 'First Post';
    ...
    {
        $this->faktory->define(['album_with_songs', 'Album'], function($f) {
            $f->name = 'Sabotage';
